...
const BlogPostCard = ({ content, author }) => {
    ...
    return (
        <Link className='flex gap-8 items-center border-b border-grey pb-5 mb-4' to={`/blog/${id}`}>
            <div className="w-full">
                ...
                <p className='my-3 text-xl font-gelasio leading-7 mx-sm:hidden md:max-[1100px]:hidden line-clamp-2'>
                    {des}
                </p>
